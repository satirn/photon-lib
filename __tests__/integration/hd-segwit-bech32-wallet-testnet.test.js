...
import { ElectrumClient as BlueElectrum, HDSegwitBech32Wallet } from '../../src';
...
describe('Bech32 Segwit HD (BIP84) TESTNET', () => {
  it('can fetch balance, transactions & utxo', async function () {
    ...
    assert.strictEqual(hd._getExternalAddressByIndex(0), 'tb1q6rz28mcfaxtmd6v789l9rrlrusdprr9pqcpvkl');
    assert.strictEqual(hd._getExternalAddressByIndex(1), 'tb1qd7spv5q28348xl4myc8zmh983w5jx32cjhkn97');
